...
public class RestaurantTestData {
    ...
    public static final RestaurantTo REST_WITH_VOTES1 = new RestaurantTo(RESTAURANT1_ID, "Р1 Mak",  2);
    public static final RestaurantTo REST_WITH_VOTES2 = new RestaurantTo(RESTAURANT1_ID+1, "Р2 Плакучая ива",  7);
    public static final RestaurantTo REST_WITH_VOTES3 = new RestaurantTo(RESTAURANT1_ID+2, "Р3 Бистро",  4);
