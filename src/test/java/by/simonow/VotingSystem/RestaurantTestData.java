...
public class RestaurantTestData {
    ...
    public static final Restaurant RESTAURANT1 = new Restaurant(RESTAURANT1_ID, "Р1 Mak", 2, MEALS_R1);
    public static final Restaurant RESTAURANT2 = new Restaurant(RESTAURANT1_ID, "Р2 Плакучая ива", 12, MEALS_R2);
    public static final Restaurant RESTAURANT3 = new Restaurant(RESTAURANT1_ID, "Р3 Бистро", 7, MEALS_R3);

    public static final List<Restaurant> RESTAURANTS = Arrays.asList(RESTAURANT2, RESTAURANT3, RESTAURANT1);

    public static Restaurant getCreated() {
        return new Restaurant(null, "Созданный ресторан", 10, null);
    }

    public static Restaurant getUpdated() {
        return new Restaurant(RESTAURANT1_ID, "Обновленный Р1 Mak", 2, null);
    }
}
